...
\ustcsetup{
  title                = {基于电激发瞬态吸收光谱技术的量子点LED载流子注入动力学研究},
  title*               = {Investigation on the Carrier Injection Dynamics in Quantum Dot LEDs Utilizing Electrically Excited Transient Absorption Spectroscopy},
  author               = {蔡晨奕},
  author*              = {Cai Chenyi},
  speciality           = {应用物理学},
  speciality*          = {Applied Physics},
  supervisor           = {樊逢佳~教授},
  supervisor*          = {Prof. Fan Fengjia},
  ...
  student-id           = {PB21020513},  % 学号，本科生需要填写
